...
import ForgotPass from './ForgotPass.tsx';
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <TouchableOpacity style={styles.signUpBtn} onPress={() => navigation.navigate("MainTabs")}>
...
const styles = StyleSheet.create({
    ...
    redirectText: { color: 'black', textDecorationColor: 'red', fontSize: 15 },
    forgot: {
        color: 'red', textDecorationLine: 'underline', textDecorationColor: 'red', fontSize: 15
    },
    signUpBtn: {
